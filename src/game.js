...
const skillDefs={
 ...
 yunque_t1_1:{"name": "Martillazo Sísmico", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 15, "type": "physical", "rarity": "common", "range": 8, "classId": "yunque", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1},
 yunque_t1_2:{"name": "Muralla Viviente", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "yunque", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 yunque_t1_3:{"name": "Ancla de Acero", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 19, "type": "physical", "rarity": "common", "range": 5, "classId": "yunque", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1},
 yunque_t1_4:{"name": "Contraataque de Bastión", "icon": "☠", "desc": "Daña y reduce temporalmente el daño del objetivo.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 21, "type": "physical", "rarity": "common", "range": 0, "classId": "yunque", "tier": 1, "classEffect": "debuff", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.8,debuffStat:'strength',debuffStatCoef:1},
 yunque_t2_1:{"name": "Carga del Coloso", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 22, "type": "physical", "rarity": "rare", "range": 0, "classId": "yunque", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.7},
 yunque_t2_2:{"name": "Piel de Fortaleza", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "yunque", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:1},
 yunque_t2_3:{"name": "Cadena Demoledora", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 26, "type": "physical", "rarity": "rare", "range": 8, "classId": "yunque", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.6},
 yunque_t2_4:{"name": "Golpe de Contención", "icon": "⊙", "desc": "Golpea y aturde brevemente al objetivo.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 28, "type": "physical", "rarity": "rare", "range": 1, "classId": "yunque", "tier": 2, "classEffect": "stun", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'strength',dmgStatCoef:1},
 yunque_t3_1:{"name": "Ciudadela Ambulante", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 29, "type": "physical", "rarity": "epic", "range": 8, "classId": "yunque", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.3},
 yunque_t3_2:{"name": "Juicio de Hierro", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 31, "type": "physical", "rarity": "epic", "range": 8, "classId": "yunque", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.2},
 yunque_t3_3:{"name": "Corazón Inquebrantable", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "yunque", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'strength',buffStatCoef:0.15},
 yunque_t3_4:{"name": "Cataclismo del Bastión", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 35, "type": "physical", "rarity": "epic", "range": 8, "classId": "yunque", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.4},
 ...
 berserker_t1_3:{"name": "Salto Rabioso", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 19, "type": "physical", "rarity": "common", "range": 5, "classId": "berserker", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1},
 ...
 berserker_t2_1:{"name": "Torbellino Magenta", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 22, "type": "physical", "rarity": "rare", "range": 0, "classId": "berserker", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.7},
 berserker_t2_2:{"name": "Implante Sobrecargado", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "berserker", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:1},
 berserker_t2_3:{"name": "Aullido de Guerra", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 26, "type": "physical", "rarity": "rare", "range": 8, "classId": "berserker", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.6},
 berserker_t2_4:{"name": "Tajo Frenético", "icon": "❣", "desc": "Golpe salvaje que abre una herida sangrante.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 28, "type": "physical", "rarity": "rare", "range": 1, "classId": "berserker", "tier": 2, "classEffect": "dot", "targetMode": "enemy", "enemyUsable": true,dmgDice:1,dmgDie:6,dmgStat:'strength',dmgStatCoef:0.6,dotDice:1,dotDie:8,dotStat:'strength',dotStatCoef:0.5},
 berserker_t3_1:{"name": "Apocalipsis Rosa", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 29, "type": "physical", "rarity": "epic", "range": 8, "classId": "berserker", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.3},
 berserker_t3_2:{"name": "Última Sobrecarga", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 31, "type": "physical", "rarity": "epic", "range": 8, "classId": "berserker", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.2},
 berserker_t3_3:{"name": "Rabia Inmortal", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "berserker", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'strength',buffStatCoef:0.15},
 berserker_t3_4:{"name": "Carnicería de Neón", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 35, "type": "physical", "rarity": "epic", "range": 8, "classId": "berserker", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.4},
 necromancer_t1_1:{"name": "Perno Funerario", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 15, "type": "magic", "rarity": "common", "range": 8, "classId": "necromancer", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1},
 ...
 necromancer_t1_3:{"name": "Marca Cadavérica", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "necromancer", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1},
 necromancer_t1_4:{"name": "Drenaje de Memoria", "icon": "☠", "desc": "Daña y reduce temporalmente el daño del objetivo.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 21, "type": "magic", "rarity": "common", "range": 0, "classId": "necromancer", "tier": 1, "classEffect": "debuff", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:0.8,debuffStat:'intelligence',debuffStatCoef:1},
 necromancer_t2_1:{"name": "Explosión de Restos", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "necromancer", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:0.7},
 necromancer_t2_2:{"name": "Muro de Huesos", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "necromancer", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 necromancer_t2_3:{"name": "Legión Corrupta", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "necromancer", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:0.6},
 necromancer_t2_4:{"name": "Robo de Esencia", "icon": "⟳", "desc": "Drena vida y energía directamente del objetivo.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "necromancer", "tier": 2, "classEffect": "drain", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'intelligence',dmgStatCoef:1},
 necromancer_t3_1:{"name": "Reinicio de Cadáver", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "necromancer", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.3},
 necromancer_t3_2:{"name": "Trono del Archiliche", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "necromancer", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.2},
 necromancer_t3_3:{"name": "Cosecha de Almas", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "necromancer", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'intelligence',buffStatCoef:0.15},
 necromancer_t3_4:{"name": "Apagón de los Muertos", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "necromancer", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.4},
 paladin_t1_1:{"name": "Golpe Radiante", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 15, "type": "magic", "rarity": "common", "range": 8, "classId": "paladin", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1},
 ...
 paladin_t1_3:{"name": "Rezo de Combate", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "paladin", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1},
 ...
 paladin_t2_1:{"name": "Lanza Solar", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "paladin", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.7},
 paladin_t2_2:{"name": "Aura de Valor", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "paladin", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 paladin_t2_3:{"name": "Juicio Compilado", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "paladin", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.6},
 paladin_t2_4:{"name": "Golpe de Absolución", "icon": "✝", "desc": "Castiga al enemigo y convierte el daño en curación.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "paladin", "tier": 2, "classEffect": "holyLeech", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatCoef:1},
 paladin_t3_1:{"name": "Cruzada de Circuitos", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "paladin", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.3},
 paladin_t3_2:{"name": "Resurrección Parcial", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "paladin", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.2},
 paladin_t3_3:{"name": "Bastión Sagrado", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "paladin", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'strength',buffStatCoef:0.15},
 paladin_t3_4:{"name": "Veredicto Celestial", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "paladin", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.4},
 jester_t1_1:{"name": "Carta Cortante", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 15, "type": "magic", "rarity": "common", "range": 8, "classId": "jester", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:1},
 jester_t1_2:{"name": "Broma Cruel", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "jester", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 jester_t1_3:{"name": "Paso de Bufón", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "jester", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:1},
 jester_t1_4:{"name": "Dado Trucado", "icon": "☠", "desc": "Daña y reduce temporalmente el daño del objetivo.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 21, "type": "magic", "rarity": "common", "range": 0, "classId": "jester", "tier": 1, "classEffect": "debuff", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:0.8,debuffStat:'luck',debuffStatCoef:1},
 jester_t2_1:{"name": "Confeti Explosivo", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "jester", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:0.7},
 jester_t2_2:{"name": "Risa Contagiosa", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "jester", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 jester_t2_3:{"name": "Sombrero Infinito", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "jester", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:0.6},
 ...
 jester_t3_1:{"name": "Gran Chiste Final", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "jester", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:1.3},
 jester_t3_2:{"name": "Ruleta del Vacío", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "jester", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:1.2},
 jester_t3_3:{"name": "Ovación Mortal", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "jester", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'luck',buffStatCoef:0.15},
 jester_t3_4:{"name": "Caos de Camerino", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "jester", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'luck',dmgStatMode:'add',dmgStatCoef:1.4},
 sniper_t1_1:{"name": "Disparo Rúnico", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 15, "type": "physical", "rarity": "common", "range": 8, "classId": "sniper", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1},
 ...
 sniper_t1_3:{"name": "Marca de Presa", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 19, "type": "physical", "rarity": "common", "range": 5, "classId": "sniper", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1},
 sniper_t1_4:{"name": "Ojo de Halcón", "icon": "☠", "desc": "Daña y reduce temporalmente el daño del objetivo.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 21, "type": "physical", "rarity": "common", "range": 0, "classId": "sniper", "tier": 1, "classEffect": "debuff", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.8,debuffStat:'agility',debuffStatCoef:1},
 sniper_t2_1:{"name": "Flecha Perforante", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 22, "type": "physical", "rarity": "rare", "range": 0, "classId": "sniper", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.7},
 sniper_t2_2:{"name": "Trampa de Cazador", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "sniper", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:1},
 sniper_t2_3:{"name": "Descarga Gemela", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 26, "type": "physical", "rarity": "rare", "range": 8, "classId": "sniper", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.6},
 sniper_t2_4:{"name": "Disparo Perforante", "icon": "➳", "desc": "Bala que atraviesa al objetivo con precisión letal.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 28, "type": "physical", "rarity": "rare", "range": 8, "classId": "sniper", "tier": 2, "classEffect": "lineShot", "targetMode": "enemy", "enemyUsable": true,dmgDice:3,dmgDie:8,dmgStat:'agility',dmgStatCoef:1},
 sniper_t3_1:{"name": "Tiro a Través del Mundo", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 29, "type": "physical", "rarity": "epic", "range": 8, "classId": "sniper", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.3},
 sniper_t3_2:{"name": "Lluvia de Flechas", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 31, "type": "physical", "rarity": "epic", "range": 8, "classId": "sniper", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.2},
 sniper_t3_3:{"name": "Ejecución Perfecta", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "sniper", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'agility',buffStatCoef:0.15},
 sniper_t3_4:{"name": "Horizonte Partido", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 35, "type": "physical", "rarity": "epic", "range": 8, "classId": "sniper", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.4},
 shaman_t1_1:{"name": "Chispa Espiritual", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 15, "type": "magic", "rarity": "common", "range": 8, "classId": "shaman", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 shaman_t1_2:{"name": "Tótem Menor", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "shaman", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 shaman_t1_3:{"name": "Voz del Trueno", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "shaman", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 shaman_t1_4:{"name": "Piel de Tormenta", "icon": "☠", "desc": "Daña y reduce temporalmente el daño del objetivo.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 21, "type": "magic", "rarity": "common", "range": 0, "classId": "shaman", "tier": 1, "classEffect": "debuff", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.8,debuffStat:'wisdom',debuffStatCoef:1},
 shaman_t2_1:{"name": "Cadena de Relámpagos", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "shaman", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.7},
 shaman_t2_2:{"name": "Tótem Sanador", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "shaman", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 shaman_t2_3:{"name": "Paso del Viento", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "shaman", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.6},
 shaman_t2_4:{"name": "Tótem de Tormenta", "icon": "⚡", "desc": "Invoca un tótem que castiga a los enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "shaman", "tier": 2, "classEffect": "stormTotem", "targetMode": "area", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatCoef:0.8},
 shaman_t3_1:{"name": "Tempestad Ancestral", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "shaman", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.3},
 shaman_t3_2:{"name": "Avatar del Rayo", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "shaman", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.2},
 shaman_t3_3:{"name": "Consejo de Espíritus", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "shaman", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'wisdom',buffStatCoef:0.15},
 shaman_t3_4:{"name": "Cielo Quebrado", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "shaman", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.4},
 thief_t1_1:{"name": "Daga de Fase", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 15, "type": "physical", "rarity": "common", "range": 8, "classId": "thief", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1},
 thief_t1_2:{"name": "Humo Cuántico", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "thief", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 thief_t1_3:{"name": "Paso Trasero", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 19, "type": "physical", "rarity": "common", "range": 5, "classId": "thief", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1},
 ...
 thief_t2_1:{"name": "Corte Imposible", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 22, "type": "physical", "rarity": "rare", "range": 0, "classId": "thief", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.7},
 thief_t2_2:{"name": "Bomba de Sombra", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "thief", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 thief_t2_3:{"name": "Robo de Energía", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 26, "type": "physical", "rarity": "rare", "range": 8, "classId": "thief", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.6},
 thief_t2_4:{"name": "Golpe desde las Sombras", "icon": "☾", "desc": "Te desvaneces y golpeas al objetivo dejándolo herido.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "thief", "tier": 2, "classEffect": "shadowStrike", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'agility',dmgStatCoef:1,dotDice:1,dotDie:6,dotStat:'agility',dotStatCoef:0.5},
 thief_t3_1:{"name": "Atraco Temporal", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 29, "type": "physical", "rarity": "epic", "range": 8, "classId": "thief", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.3},
 thief_t3_2:{"name": "Evasión Absoluta", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "thief", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.2},
 thief_t3_3:{"name": "Mil Cortes", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "thief", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'agility',buffStatCoef:0.15},
 thief_t3_4:{"name": "Desaparición Cuántica", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "thief", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.4},
 cleric_t1_1:{"name": "Luz Reparadora", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 15, "type": "magic", "rarity": "common", "range": 8, "classId": "cleric", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 cleric_t1_2:{"name": "Maza Bendita", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "cleric", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 cleric_t1_3:{"name": "Barrera Piadosa", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "cleric", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 ...
 cleric_t2_1:{"name": "Rayo de Silicio", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "cleric", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.7},
 cleric_t2_2:{"name": "Purga de Corrupción", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "cleric", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 cleric_t2_3:{"name": "Santuario Portátil", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "cleric", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.6},
 cleric_t2_4:{"name": "Silencio Sagrado", "icon": "⊘", "desc": "Golpea y silencia al objetivo, impidiendo su magia.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "cleric", "tier": 2, "classEffect": "silence", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatCoef:0.8},
 cleric_t3_1:{"name": "Resurrección de Emergencia", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "cleric", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.3},
 cleric_t3_2:{"name": "Diluvio Sagrado", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "cleric", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.2},
 cleric_t3_3:{"name": "Avatar del Templo", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "cleric", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'wisdom',buffStatCoef:0.15},
 cleric_t3_4:{"name": "Juicio del Dios Roto", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "cleric", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.4},
 ...
 entropyMage_t1_3:{"name": "Paso Improbable", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "entropyMage", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1},
 ...
 entropyMage_t2_1:{"name": "Onda de Ruina", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "entropyMage", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:0.7},
 entropyMage_t2_2:{"name": "Colapso Local", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "entropyMage", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 entropyMage_t2_3:{"name": "Robo de Tiempo", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "entropyMage", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:0.6},
 entropyMage_t2_4:{"name": "Eco de Entropía", "icon": "∿", "desc": "Inflige un daño que se repite en el tiempo.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "entropyMage", "tier": 2, "classEffect": "echoDot", "targetMode": "enemy", "enemyUsable": true,dmgDice:1,dmgDie:6,dmgStat:'intelligence',dmgStatCoef:0.6,dotDice:2,dotDie:6,dotStat:'intelligence',dotStatCoef:0.6},
 entropyMage_t3_1:{"name": "Fin Estadístico", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "entropyMage", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.3},
 entropyMage_t3_2:{"name": "Agujero de Entropía", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "entropyMage", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.2},
 entropyMage_t3_3:{"name": "Deshacer Realidad", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "entropyMage", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'intelligence',buffStatCoef:0.15},
 entropyMage_t3_4:{"name": "Muerte Térmica", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "entropyMage", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.4},
 bountyHunter_t1_1:{"name": "Tiro de Contrato", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 15, "type": "physical", "rarity": "common", "range": 8, "classId": "bountyHunter", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1},
 ...
 bountyHunter_t2_1:{"name": "Granada Rastreadora", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 22, "type": "physical", "rarity": "rare", "range": 0, "classId": "bountyHunter", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.7},
 bountyHunter_t2_2:{"name": "Doble Disparo", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "bountyHunter", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:1},
 bountyHunter_t2_3:{"name": "Blindaje Mercenario", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 26, "type": "physical", "rarity": "rare", "range": 8, "classId": "bountyHunter", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.6},
 bountyHunter_t2_4:{"name": "Red de Captura", "icon": "⊠", "desc": "Inmoviliza al objetivo con una red de cazarrecompensas.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 28, "type": "physical", "rarity": "rare", "range": 6, "classId": "bountyHunter", "tier": 2, "classEffect": "bountyRoot", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatCoef:1},
 bountyHunter_t3_1:{"name": "Caza Total", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 29, "type": "physical", "rarity": "epic", "range": 8, "classId": "bountyHunter", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.3},
 bountyHunter_t3_2:{"name": "Misil de Bolsillo", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 31, "type": "physical", "rarity": "epic", "range": 8, "classId": "bountyHunter", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.2},
 bountyHunter_t3_3:{"name": "Sentencia del Contrato", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "bountyHunter", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'agility',buffStatCoef:0.15},
 bountyHunter_t3_4:{"name": "Nadie Escapa", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 35, "type": "physical", "rarity": "epic", "range": 8, "classId": "bountyHunter", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.4},
 druid_t1_1:{"name": "Espina de Chatarra", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 15, "type": "magic", "rarity": "common", "range": 8, "classId": "druid", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 druid_t1_2:{"name": "Corteza Reforzada", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "druid", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 druid_t1_3:{"name": "Raíz Enredadora", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "druid", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 ...
 druid_t2_1:{"name": "Enjambre Metálico", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "druid", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.7},
 druid_t2_2:{"name": "Forma de Bestia", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "druid", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 druid_t2_3:{"name": "Bosque Improvisado", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "druid", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.6},
 druid_t2_4:{"name": "Enredadera Devoradora", "icon": "✤", "desc": "Raíces que inmovilizan y desangran al objetivo.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "druid", "tier": 2, "classEffect": "rootBleed", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatCoef:0.8,dotDice:1,dotDie:6,dotStat:'wisdom',dotStatCoef:0.5},
 druid_t3_1:{"name": "Avatar del Chatarral", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "druid", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.3},
 druid_t3_2:{"name": "Raíces del Mundo", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "druid", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.2},
 druid_t3_3:{"name": "Manada Aumentada", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "druid", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'wisdom',buffStatCoef:0.15},
 druid_t3_4:{"name": "Primavera Radiactiva", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "druid", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.4},
 monk_t1_1:{"name": "Puño del Instante", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 15, "type": "physical", "rarity": "common", "range": 8, "classId": "monk", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1},
 monk_t1_2:{"name": "Paso Circular", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "monk", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 monk_t1_3:{"name": "Respiración Serena", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "stamina", "cost": 19, "type": "physical", "rarity": "common", "range": 5, "classId": "monk", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1},
 ...
 monk_t2_1:{"name": "Eco del Golpe", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 22, "type": "physical", "rarity": "rare", "range": 0, "classId": "monk", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.7},
 monk_t2_2:{"name": "Bucle Defensivo", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "monk", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:1},
 monk_t2_3:{"name": "Palma del Segundo Perdido", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 26, "type": "physical", "rarity": "rare", "range": 8, "classId": "monk", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:0.6},
 monk_t2_4:{"name": "Golpe Sellado", "icon": "☯", "desc": "Marca al objetivo para amplificar el siguiente golpe.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 28, "type": "physical", "rarity": "rare", "range": 1, "classId": "monk", "tier": 2, "classEffect": "comboMark", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'agility',dmgStatCoef:1},
 monk_t3_1:{"name": "Mil Puños Simultáneos", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 29, "type": "physical", "rarity": "epic", "range": 8, "classId": "monk", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.3},
 monk_t3_2:{"name": "Detener el Turno", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 31, "type": "physical", "rarity": "epic", "range": 8, "classId": "monk", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.2},
 monk_t3_3:{"name": "Regreso al Instante", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "monk", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'agility',buffStatCoef:0.15},
 monk_t3_4:{"name": "Rueda Infinita", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 35, "type": "physical", "rarity": "epic", "range": 8, "classId": "monk", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'agility',dmgStatMode:'add',dmgStatCoef:1.4},
 ...
 engineer_t1_3:{"name": "Mina Improvisada", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "engineer", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1},
 ...
 engineer_t2_1:{"name": "Lanzallamas Casero", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "engineer", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:0.7},
 engineer_t2_2:{"name": "Campo Magnético", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "engineer", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 engineer_t2_3:{"name": "Autómata de Guerra", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "engineer", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:0.6},
 engineer_t2_4:{"name": "Mina de Precisión", "icon": "☒", "desc": "Coloca una mina que detona con los enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 5, "classId": "engineer", "tier": 2, "classEffect": "trap", "targetMode": "area", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'intelligence',dmgStatCoef:1},
 engineer_t3_1:{"name": "Fábrica Instantánea", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "engineer", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.3},
 engineer_t3_2:{"name": "Cañón de Singularidad", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "engineer", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.2},
 engineer_t3_3:{"name": "Ejército Mecánico", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "engineer", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'intelligence',buffStatCoef:0.15},
 engineer_t3_4:{"name": "Reactor Prohibido", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "engineer", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'intelligence',dmgStatMode:'add',dmgStatCoef:1.4},
 seer_t1_1:{"name": "Aguja Psíquica", "icon": "✦", "desc": "Ataque a distancia contra el enemigo visible más cercano.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 15, "type": "magic", "rarity": "common", "range": 8, "classId": "seer", "tier": 1, "classEffect": "ranged", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 seer_t1_2:{"name": "Visión Cercana", "icon": "▣", "desc": "Obtienes un escudo que escala con el nivel de habilidad.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 17, "type": "utility", "rarity": "common", "range": 0, "classId": "seer", "tier": 1, "classEffect": "shield", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:0.8},
 seer_t1_3:{"name": "Paso Predicho", "icon": "➤", "desc": "Avanzas hacia un enemigo y golpeas al llegar.", "cd": 5, "unlock": "Clase", "resource": "mana", "cost": 19, "type": "magic", "rarity": "common", "range": 5, "classId": "seer", "tier": 1, "classEffect": "dash", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 ...
 seer_t2_1:{"name": "Rayo del Futuro", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 22, "type": "magic", "rarity": "rare", "range": 0, "classId": "seer", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.7},
 seer_t2_2:{"name": "Espejo de Posibilidades", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "seer", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1},
 seer_t2_3:{"name": "Destino Torcido", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 26, "type": "magic", "rarity": "rare", "range": 8, "classId": "seer", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:0.6},
 seer_t2_4:{"name": "Marca del Destino", "icon": "☥", "desc": "Marca a un enemigo con un augurio fatal.", "cd": 7, "unlock": "Clase", "resource": "mana", "cost": 28, "type": "magic", "rarity": "rare", "range": 6, "classId": "seer", "tier": 2, "classEffect": "doomMark", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'wisdom',dmgStatCoef:0.8},
 seer_t3_1:{"name": "Profecía Cumplida", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 29, "type": "magic", "rarity": "epic", "range": 8, "classId": "seer", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.3},
 seer_t3_2:{"name": "Detener la Catástrofe", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 31, "type": "magic", "rarity": "epic", "range": 8, "classId": "seer", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.2},
 seer_t3_3:{"name": "Mil Futuros", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "seer", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'wisdom',buffStatCoef:0.15},
 seer_t3_4:{"name": "Fin Inevitable", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "mana", "cost": 35, "type": "magic", "rarity": "epic", "range": 8, "classId": "seer", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'wisdom',dmgStatMode:'add',dmgStatCoef:1.4},
 ...
 beastGuardian_t2_1:{"name": "Embate Bestial", "icon": "✹", "desc": "Golpea a varios enemigos cercanos.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 22, "type": "physical", "rarity": "rare", "range": 0, "classId": "beastGuardian", "tier": 2, "classEffect": "aoe", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.7},
 beastGuardian_t2_2:{"name": "Piel de Quimera", "icon": "✚", "desc": "Recupera vida y parte del recurso principal.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 24, "type": "utility", "rarity": "rare", "range": 0, "classId": "beastGuardian", "tier": 2, "classEffect": "heal", "enemyUsable": true,dmgDice:3,dmgDie:6,dmgStat:'vitality',dmgStatMode:'add',dmgStatCoef:1},
 beastGuardian_t2_3:{"name": "Manada Cibernética", "icon": "ϟ", "desc": "Realiza varios impactos contra enemigos visibles.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 26, "type": "physical", "rarity": "rare", "range": 8, "classId": "beastGuardian", "tier": 2, "classEffect": "multihit", "enemyUsable": true,dmgDice:2,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:0.6},
 beastGuardian_t2_4:{"name": "Zarpazo Desgarrador", "icon": "⚔", "desc": "Zarpazo brutal que abre heridas profundas.", "cd": 7, "unlock": "Clase", "resource": "stamina", "cost": 28, "type": "physical", "rarity": "rare", "range": 1, "classId": "beastGuardian", "tier": 2, "classEffect": "hookBleed", "targetMode": "enemy", "enemyUsable": true,dmgDice:2,dmgDie:8,dmgStat:'strength',dmgStatCoef:1,dotDice:1,dotDie:8,dotStat:'strength',dotStatCoef:0.5},
 beastGuardian_t3_1:{"name": "Avatar de la Bestia", "icon": "★", "desc": "Ataque potente en un área amplia.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 29, "type": "physical", "rarity": "epic", "range": 8, "classId": "beastGuardian", "tier": 3, "classEffect": "ultimate", "enemyUsable": true,dmgDice:5,dmgDie:6,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.3},
 beastGuardian_t3_2:{"name": "Caza Salvaje", "icon": "✂", "desc": "Inflige daño enorme a enemigos heridos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 31, "type": "physical", "rarity": "epic", "range": 8, "classId": "beastGuardian", "tier": 3, "classEffect": "execute", "enemyUsable": true,dmgDice:3,dmgDie:10,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.2},
 beastGuardian_t3_3:{"name": "Corazón de Alfa", "icon": "Ψ", "desc": "Mejora daño, armadura y regeneración durante varios turnos.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 33, "type": "utility", "rarity": "epic", "range": 0, "classId": "beastGuardian", "tier": 3, "classEffect": "buff", "enemyUsable": true,buffStat:'strength',buffStatCoef:0.15},
 beastGuardian_t3_4:{"name": "Estampida Aumentada", "icon": "☄", "desc": "Habilidad definitiva de gran daño contra todos los enemigos visibles.", "cd": 10, "unlock": "Clase", "resource": "stamina", "cost": 35, "type": "physical", "rarity": "epic", "range": 8, "classId": "beastGuardian", "tier": 3, "classEffect": "massive", "enemyUsable": true,dmgDice:5,dmgDie:8,dmgStat:'strength',dmgStatMode:'add',dmgStatCoef:1.4}
};
...
function recomputeDerived(){
 ...
 for(const b of p.activeBuffs||[])for(const k of ['strength','vitality','agility','luck','intelligence','wisdom'])if(b.effects?.[k])allStats[k]=Math.round(allStats[k]*(1+b.effects[k]));
...
function applyEnemyStatDebuff(e,stat,amount,turns,label){
 e.statuses=e.statuses||[];
 ...
 e.stats=e.stats||{};e.stats[stat]=(e.stats[stat]||0)-amount;
 e.statuses.push({type:'statDebuff',stat,power:amount,turns,label});
 log(`${e.name}: ${label} (-${amount} ${DEFENSE_STAT_LABELS[stat]||stat}) durante ${turns} turnos.`,'combat')
}
function tickEnemyStatuses(){
 for(const e of [...game.enemies]){
  ...
  for(const s of e.statuses||[]){
   ...
   if(s.turns<=0&&s.type==='statDebuff')e.stats[s.stat]=(e.stats[s.stat]||0)+s.power;
  }
...
function applyClassEffectState(effect,id,target,x,y,lvl){
 ...
 if(effect==='poison'||effect==='burn'||effect==='bleed'||effect==='dot'||effect==='decayDot'){hit(target,.7);status(target,effect,4,skillDotPower(id,2+lvl*.7),d.name);return true}
 if(effect==='root'||effect==='rootBleed'||effect==='bountyRoot'){hit(target,.7);status(target,'root',2,0,'Inmovilizado');if(effect==='rootBleed')status(target,'dot',4,skillDotPower(id,2+lvl*.6),'Sangrado');return true}
 return false
}
...
function applyCreativeClassEffect(id,target,x,y){
 ...
 if(['root','pullRoot','rootBleed','bountyRoot'].includes(effect)){hit(target);addEnemyStatus(target,'root',2+Math.floor(lvl/4),0,'Inmovilizado');if(effect.includes('Bleed'))addEnemyStatus(target,'dot',4,skillDotPower(id,2+lvl*.5),'Sangrado');return true}
 if(['freeze','delayedFreeze'].includes(effect)){hit(target,.8);addEnemyStatus(target,'freeze',2,0,'Congelado');return true}
 if(['bleed','burn','poison','dot','decayDot','echoDot','delayedPoison'].includes(effect)){hit(target,.75);addEnemyStatus(target,effect==='poison'?'poison':effect==='decayDot'?'decayDot':'dot',4+Math.floor(lvl/4),skillDotPower(id,2+lvl*.8),d.name);return true}
 ...
 if(['shadowStrike','holyDash','leapBuff'].includes(effect)){teleportPlayerTo(Math.max(1,target.x-Math.sign(target.x-p.x)),Math.max(1,target.y-Math.sign(target.y-p.y)));hit(target,1.15);if(effect==='shadowStrike')addEnemyStatus(target,'dot',4,skillDotPower(id,2+lvl*.5),'Sangrado');return true}
 if(['hookBleed'].includes(effect)){hit(target,.9);addEnemyStatus(target,'dot',4,skillDotPower(id,2+lvl*.5),'Sangrado');return true}
 ...
 for(const e of targets){hit(e,d.tier===3?1.25:.85);
  ...
  if(/burn|plague|dot|storm|rain|decay|nova/.test(effect))addEnemyStatus(e,'dot',3,skillDotPower(id,2+lvl*.6),d.name);
...
function resolveTargetedSkill(slot,x,y){
 ...
 if(mode==='enemy'){
  ...
  if(d.classEffect==='debuff'||['shockTrap','ironHook'].includes(id)){const turns=2+Math.floor(skillLevel(id)/3);if(d.classEffect==='debuff'&&d.debuffStat)applyEnemyStatDebuff(enemy,d.debuffStat,Math.max(1,Math.round((d.debuffStatCoef??1)*(2+skillLevel(id)))),turns,d.name);else enemy.weakened=turns;enemy.stunned=1}
...
function useSkill(slot){
 ...
 if(!used&&def.classEffect){
  ...
  else if(def.classEffect==='shield'){const turns=4+Math.floor(lvl/2);applyBuff(id,def.name,turns,{armor:.22+lvl*.01});game.player.shield+=resolveSkillPower(id);used=true}
  ...
  else if(def.classEffect==='debuff'&&nearest){attack(nearest,base,{skillId:id});const turns=2+Math.floor(lvl/3);if(def.debuffStat)applyEnemyStatDebuff(nearest,def.debuffStat,Math.max(1,Math.round((def.debuffStatCoef??1)*(2+lvl))),turns,def.name);else nearest.weakened=turns;used=true}
  ...
  else if(def.classEffect==='buff'){const turns=6+Math.floor(lvl/2);const stat=def.buffStat||'damage';applyBuff(id,def.name,turns,{[stat]:(def.buffStatCoef??.15)+lvl*.01});game.player.shield+=5+lvl*2;used=true}
...
function loadSkillIntoForm(skillId){
 ...
 document.getElementById('configSkillBuffStatCoef').value=s.buffStatCoef??.15;
 document.getElementById('configSkillDebuffStat').value=s.debuffStat||'';
 document.getElementById('configSkillDebuffStatCoef').value=s.debuffStatCoef??1;
