...
const weaponRows=[
 {category:'Armas blancas steampunk básicas',legacy:['Espadas cortas'],stat:'strength',iconFolder:'weaponsCP',names:['Cuchillo de mecánico', 'Daga de caldera', 'Estoque dentado', 'Machete industrial', 'Espada de acero pulido', 'Sable de oficial', 'Garrote remachado', 'Hacha de ingeniero', 'Lanza de latón', 'Maza de pistón']},
 ...
 {category:'Espadas eléctricas iniciales',legacy:['Dagas, lanzas y alabardas'],stat:'strength',iconFolder:'weaponsCP',names:['Daga de bobina', 'Kukri electrificado', 'Sable de dientes', 'Espada conductora', 'Espada de plasma azul', 'Estoque de descarga', 'Bastón de bobina Tesla', 'Hacha de inducción', 'Lanza de arco eléctrico', 'Maza acumuladora']},
 ...
 {category:'Armas ciberpunk de neón',legacy:['Garras y guanteletes'],stat:'agility',iconFolder:'weaponsCP',names:['Daga de neón azul', 'Kukri de neón violeta', 'Hoja monomolecular cian', 'Espada de plasma magenta', 'Mandoble holográfico', 'Estoque de energía violeta', 'Bastón de plasma dual', 'Hacha de neón', 'Lanza fotónica', 'Maza de núcleo violeta']},
 ...
 {category:'Armas térmicas',legacy:['Látigos'],stat:'strength',iconFolder:'weaponsCP',names:['Daga incandescente', 'Kukri térmico', 'Sable de fuego', 'Espada láser roja', 'Mandoble de magma', 'Estoque ígneo', 'Bastón de combustión', 'Hacha térmica', 'Lanza de fusión', 'Maza de reactor rojo']},
 {category:'Armas criogénicas',legacy:['Bastones mágicos'],stat:'intelligence',iconFolder:'weaponsCP',names:['Daga criogénica', 'Kukri de hielo tecnológico', 'Sable glacial', 'Espada láser azul', 'Mandoble criónico', 'Estoque de escarcha', 'Bastón de congelación', 'Hacha criogénica', 'Lanza de hielo comprimido', 'Maza de núcleo glacial']},
 {category:'Armas tóxicas y biotecnológicas',legacy:['Martillos de guerra'],stat:'luck',iconFolder:'weaponsCP',names:['Daga biocortante', 'Kukri venenoso', 'Sable de ácido', 'Espada de plasma verde', 'Mandoble biotecnológico', 'Estoque tóxico', 'Pistola de esporas', 'Hacha corrosiva', 'Lanza de bioenergía', 'Granada química']},
 ...
 {category:'Armas tecnomágicas legendarias',legacy:['Espadas legendarias'],stat:'wisdom',iconFolder:'weaponsCP',names:['Pistola del reloj divino', 'Sable de energía dorada', 'Hoja sierra de plasma', 'Espada del núcleo celeste', 'Mandoble del cronoingeniero', 'Bastón del sol mecánico', 'Hacha de tormenta Tesla', 'Lanza del autómata real', 'Maza del gran reloj', 'Dron serafín mecánico']},
 {category:'Armas míticas ciberpunk',legacy:['Armas artefacto y armas míticas'],stat:'wisdom',iconFolder:'weaponsCP',names:['Cañón del corazón azul', 'Guadaña del vacío violeta', 'Espada de plasma imperial', 'Hoja del reactor carmesí', 'Estrella de energía criónica', 'Rifle del arcángel mecánico', 'Hacha del señor de las máquinas', 'Lanza de fotones', 'Bastón de singularidad violeta', 'Núcleo del apocalipsis mecánico']}
];
...
function weaponIconFolder(row){return weaponRows[row]?.iconFolder||'weapons'}
function weaponIconBase(row,col){return `${weaponIconFolder(row)}/icon_r${String(row+1).padStart(2,'0')}_c${String(col+1).padStart(2,'0')}`}
function weaponIconCandidates(row,col){const base=weaponIconBase(row,col),classic=`weapons/icon_r${String(row+1).padStart(2,'0')}_c${String(col+1).padStart(2,'0')}`,legacy=`resources/weapons/icon_r${String(row+1).padStart(2,'0')}_c${String(col+1).padStart(2,'0')}`;return[`${base}.png`,base,`${base}.webp`,`${base}.PNG`,`${classic}.png`,classic,`${legacy}.png`,legacy]}
...
function makeStarterWeapon(classId){
 ...
 return{
  ...
  flavor:`Arma inicial de clase: ${canonicalCategory}. Icono básico individual en weaponsCP.`,
  defenseStat:stat,
...
function serializeGame(){
 return JSON.stringify({version:'0.23',savedAt:new Date().toISOString(),game},null,2);
}
